    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (count != 0) {
            try {
                ...
                bindingOpt40.image1.setImageDrawable(getDrawable().get(index1 - 1));
                bindingOpt40.image2.setImageDrawable(getDrawable().get(index2 - 1));
                bindingOpt40.image3.setImageDrawable(getDrawable().get(index3 - 1));
                bindingOpt40.image4.setImageDrawable(getDrawable().get(index4 - 1));
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
        ...
        bindingOpt40.image1.setOnTouchListener(new OnDoubleClickListener(new OnDoubleClickListener.DoubleClickCallback() {
            @Override
                    ...
                    AlertDialog dialog = new AlertDialog.Builder(Option40Activity.this)
                            ...
                            .setPositiveButton(getString(R.string.remind3), new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    Toast.makeText(Option40Activity.this, getString(R.string.finish_quit_remind), Toast.LENGTH_SHORT).show();
        ...
        bindingOpt40.image2.setOnTouchListener(new OnDoubleClickListener(new OnDoubleClickListener.DoubleClickCallback() {
            @Override
            public void onDoubleClick() {
                // TODO Auto-generated method stub
                Date date = new Date();
        ...
        bindingOpt40.image3.setOnTouchListener(new OnDoubleClickListener(new OnDoubleClickListener.DoubleClickCallback() {
            @Override
            public void onDoubleClick() {
                // TODO Auto-generated method stub
                Date date = new Date();
        ...
        bindingOpt40.image4.setOnTouchListener(new OnDoubleClickListener(new OnDoubleClickListener.DoubleClickCallback() {
            @Override
            public void onDoubleClick() {
                // TODO Auto-generated method stub
                Date date = new Date();
