        ...
        image1.setOnTouchListener(new OnDoubleClickListener(new OnDoubleClickListener.DoubleClickCallback() {
            ...
            public void onDoubleClick() {
                ...
                if (number_count2 == 19) {
                    ...
                    if (count >= 18) {
                        String sql2 = "update " + Constants.TABLE_NAME + " set result='嗅觉功能正常' , test_channel='20项气味测试' where ID=" + id;
                        sqliteDatabase.execSQL(sql2);
                        cv1.put("result","嗅觉功能正常");
                    } else if (count >= 15 && count < 18) {
                        String sql2 = "update " + Constants.TABLE_NAME + " set result='嗅觉功能障碍' , test_channel='20项气味测试' where ID=" + id;
                        sqliteDatabase.execSQL(sql2);
                        cv1.put("result","嗅觉功能障碍");
                    } else {
                        String sql2 = "update " + Constants.TABLE_NAME + " set result='嗅觉功能丧失' , test_channel='20项气味测试' where ID=" + id;
                        sqliteDatabase.execSQL(sql2);
