...
public class Option20Activity extends BaseActivity {
            ...
            switch (msg.what) {
                ...
                case 1:
                    ...
                    if (retryCount_savce[0] < retry_20) {
                        ...
                        bindingOpt20.retryProgressBar.setVisibility(View.GONE);
                        bindingOpt20.butRetryClicked.setVisibility(View.GONE);
                        Toast.makeText(Option20Activity.this, getString(R.string.btn_retry_complete), Toast.LENGTH_SHORT).show();
                    }
                    break;
            }
        }
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        bindingOpt20.image1.setOnTouchListener(new OnDoubleClickListener(() -> {
            ...
            if (number_count2 == 19) {
                ...
                cv1.put("answercount"," ");
                sqliteDatabase.insert(Constants.TABLE_NAME4, null, cv1);
                Intent intent = new Intent(Option20Activity.this, TestFinishActivity.class);
        ...
        bindingOpt20.image2.setOnTouchListener(new OnDoubleClickListener(() -> {
            ...
            if (number_count2 == 19) {
                ...
                cv1.put("answercount", count12 + "/" + "20");
                if (count12 >= 18) {
                    if(option2_shareprefe.getInt("language_set",0) == 0){
                        sql_base = sql2_CN_NO;
                    }else {
        ...
        bindingOpt20.image3.setOnTouchListener(new OnDoubleClickListener(() -> {
            ...
            if (number_count2 == 19) {
                ...
                cv1.put("answercount", count14 + "/" + "20");
                if (count14 >= 18) {
                    if(option2_shareprefe.getInt("language_set",0) == 0){
                        sql_base = sql2_CN_NO;
                    }else {
        ...
        bindingOpt20.image4.setOnTouchListener(new OnDoubleClickListener(() -> {
            ...
            if (number_count2 == 19) {
                ...
                cv1.put("answercount", count13 + "/" + "20");
                if (count13 >= 18) {
                    if(option2_shareprefe.getInt("language_set",0) == 0){
                        sql_base = sql2_CN_NO;
                    }else {
    ...
    public void onConfigurationChanged(@NonNull Configuration newConfig) {
        ...
        if (this.getResources().getConfiguration().orientation
            ...
            setContentView(bindingOpt20.getRoot());
            Toast.makeText(Option20Activity.this,"横屏模式",Toast.LENGTH_SHORT).show();
        } else if (this.getResources().getConfiguration().orientation
                == Configuration.ORIENTATION_PORTRAIT) {
            setContentView(bindingOpt20.getRoot());
            Toast.makeText(Option20Activity.this,"竖屏模式",Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void onBackPressed() {
        new DroidDialog.Builder(this)
                ...
                .color(ContextCompat.getColor(Option20Activity.this, R.color.orange), ContextCompat.getColor(Option20Activity.this, R.color.white),
                        ContextCompat.getColor(Option20Activity.this, R.color.black))
                .show();
    }
