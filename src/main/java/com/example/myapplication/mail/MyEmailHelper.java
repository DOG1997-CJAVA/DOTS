package com.example.myapplication.mail;
...
public class MyEmailHelper {
    ...
    //TODO 需要改成自己的账号和授权密码
    private String user = "olfactory2021@163.com";   // 使用者账号
    private String password = "FEUAYETVLVZAGFRW"; //使用者SMTP授权密码 20212是“WFGJBXVADECENXCY”
