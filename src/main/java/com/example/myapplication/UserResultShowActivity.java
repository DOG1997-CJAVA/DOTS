...
public class UserResultShowActivity extends BaseActivity {
    private ArrayList<ManagementInfo> resultList;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_user_result_show);
        //创建或打开数据库
        ...
        while (cursor.moveToNext()) {
            ...
            String educate = cursor.getString(cursor.getColumnIndex("educate"));
            ManagementInfo ri = new ManagementInfo(ID, name, age, gender, test_channel,result,educate);    //ResultInfo存一个条目的数据
        ...
        lv.setEmptyView(findViewById(R.id.isEmpty));
        lv.setAdapter(new BaseAdapter() {
            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                ...
                if (convertView == null) {
                    view = View.inflate(getBaseContext(), R.layout.activity_user_result_show, null);
                } else {
                    view = convertView;
                }
                ...
                result.setText("null");//暂不显示 测试结果
                view.setOnClickListener(v -> {
                    MaterialDialog dialog = new MaterialDialog(UserResultShowActivity.this, MaterialDialog.getDEFAULT_BEHAVIOR());
